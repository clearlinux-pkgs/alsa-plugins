...
Source0  : https://www.alsa-project.org/files/pub/plugins/alsa-plugins-1.2.1.tar.bz2
...
%prep
%setup -q -n alsa-plugins-1.2.1
cd %{_builddir}/alsa-plugins-1.2.1
pushd ..
cp -a alsa-plugins-1.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1575260976
...
cp %{_builddir}/alsa-plugins-1.2.1/COPYING %{buildroot}/usr/share/package-licenses/alsa-plugins/597bf5f9c0904bd6c48ac3a3527685818d11246d
cp %{_builddir}/alsa-plugins-1.2.1/COPYING.GPL %{buildroot}/usr/share/package-licenses/alsa-plugins/68c94ffc34f8ad2d7bfae3f5a6b996409211c1b1
pushd ../buildavx2/
%make_install_avx2
popd
%make_install
